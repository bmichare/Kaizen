...
const AddLogDetails = (props) => {
  ...
  //Takes form data and converts to object. Note that hours and minutes are converted from string to integers
...
export default connect(mapStateToProps, null)(AddLogDetails);
